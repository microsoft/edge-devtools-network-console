...
import { Pivot, PivotItem, TextField, IconButton, PivotLinkSize } from 'office-ui-fabric-react';
            ...
            <div>
                {editingName ? (
                    <TextField
                        ...
                        onBlur={_e => setEditingName(false)}
                        onKeyUp={e => {
                        ...
                        />) :
                    (<div>
                        <span {...Styles.REQUEST_TITLE_STYLE}>{props.request.name || `${props.request.verb} ${props.request.url}`}</span>
                        <IconButton iconProps={{iconName: 'Rename'}} ariaLabel="Rename" onClick={_e => setEditingName(true)} />
                    </div>)
                }
            </div>
            <div>
