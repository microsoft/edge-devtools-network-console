...
`environmentAuthPath` is an array of strings. These parameters are deprecated in 0.10.0-preview
...
interface IHostCollection {
    ...
    /** New in 0.10.0-preview **/
    authorization: INetConsoleAuthorization | undefined;
}
```

The `authorization` parameter is introduced in 0.10.0-preview. This allows the host to keep the
